// Generated by gencpp from file test/Key.msg
// DO NOT EDIT!


#ifndef TEST_MESSAGE_KEY_H
#define TEST_MESSAGE_KEY_H
...
struct Key_
{
  ...
  typedef boost::shared_ptr< ::test::Key_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::test::Key_<ContainerAllocator> const> ConstPtr;

}; // struct Key_

typedef ::test::Key_<std::allocator<void> > Key;

typedef boost::shared_ptr< ::test::Key > KeyPtr;
typedef boost::shared_ptr< ::test::Key const> KeyConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::test::Key_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::test::Key_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'test': ['/home/roboworker/catkin_ws/src/test/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::test::Key_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::test::Key_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::Key_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::Key_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::Key_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::Key_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::test::Key_<ContainerAllocator> >
{
  ...
  static const char* value(const ::test::Key_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5d57616b5631968bULL;
  static const uint64_t static_value2 = 0x8f1d31d23c83281fULL;
};

template<class ContainerAllocator>
struct DataType< ::test::Key_<ContainerAllocator> >
{
  static const char* value()
  {
    return "test/Key";
...
template<class ContainerAllocator>
struct Definition< ::test::Key_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::test::Key_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::test::Key_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test::Key_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
